...
var Tpl1 = '<li>' +
    '<p class="data-count">56891</p>' +
    '<span class="data-name">XZP</span>' +
    '</li>' +
    '<li>' +
    '<p class="data-count">33354</p>' +
    '<span class="data-name">JHNC</span>' +
    '</li>' +
    '<li>' +
    '<p class="data-count">30753</p>' +
    '<span class="data-name">QJZLCHDD</span>' +
    '</li>';
var Tpl2 = '<li>' +
        ...
        series: [
            {
                ...
                radius: '40%',
                center: ['50%', '50%'],
                data: [{ 'name': 'JHNC', 'value': 393600 }, { 'name': 'XZP', 'value': 267521 }, { 'name': 'QJZLCHDD', 'value': 246422 }, { 'name': 'QJLK', 'value': 217345 }, { 'name': '', 'value': 164806 }, { 'name': 'JNLK', 'value': 150188 }, { 'name': 'LYQ', 'value': 135564 }, { 'name': 'SZP', 'value': 133112 }, { 'name': 'ZHDD', 'value': 132915 }, { 'name': 'HYZT', 'value': 128245 }, { 'name': 'JYHC', 'value': 116016 }, { 'name': 'DYZX', 'value': 109242 }, { 'name': 'HYJS', 'value': 107856 }, { 'name': 'TPZT', 'value': 104845 }, { 'name': 'TPHC', 'value': 103003 }, { 'name': 'DZP', 'value': 71353 }, { 'name': 'YJQ', 'value': 69957 }, { 'name': 'PLWXLRXR', 'value': 32056 }, { 'name': 'BJZT', 'value': 14619 }, { 'name': 'BJQJ', 'value': 10647 }, { 'name': 'SHUXIYILU', 'value': 1759 }],
                itemStyle: {
                    emphasis: {
                        shadowBlur: 10,
                        shadowOffsetX: 0,
...
function init_myChart7() {
    ...
    var xData = ['川', '无', '渝', '粤', '云', '浙', '苏', '鲁', '贵', '闽', '陕', '新', '湘', '豫', '沪', '鄂', '桂', '皖', '青', '甘', '冀'];
    var yData = [245866, 6063, 4554, 3332, 844, 836, 751, 701, 504, 380, 360, 340, 309, 303, 288, 266, 242, 231, 155, 155, 148];
    option = {
        color: colorList,
        "tooltip": {
            "trigger": "axis",
